...
// /update-activity is a POST endpoint to add user activity
if (authController.updateActivity) {
  mustBeFunction(authController.updateActivity, 'updateActivity');
  router.post('/update-activity', authController.updateActivity);
}
